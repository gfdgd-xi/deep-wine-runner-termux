...
function InstallWine() {
    ...
    pkg reinstall ./*.deb wine-stable qemu-system-x86-64 -y --no-install-recommends
...
echo ===================================
echo 继续安装
pkg install aria2 jq -y  
echo ===================================
# tigervnc
echo 是否需要配置 VNC 以便显示 GUI（用户界面）[Y/n]
echo 提示：配置过 termux-x11 等无需配置
read result
